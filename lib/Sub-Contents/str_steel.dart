...
class StrSteelPage extends StatefulWidget {
  const StrSteelPage({super.key});
  @override
  State<StrSteelPage> createState() => _StrSteelPageState();
}

class _StrSteelPageState extends State<StrSteelPage> {
  int _quantity = 1;
  final double _itemPrice = 599; // Price per item for Structural Steel Frame
