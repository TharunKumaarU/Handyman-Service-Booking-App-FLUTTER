...
class PolWoodFurnPage extends StatefulWidget {
  const PolWoodFurnPage({super.key});

  @override
  State<PolWoodFurnPage> createState() => _PolWoodFurnPageState();
}

class _PolWoodFurnPageState extends State<PolWoodFurnPage> {
  // Initial quantity
  int _quantity = 1;

  // Pricing details for Polish Wood Furniture service
  final double _itemPrice = 499; // Price per item
