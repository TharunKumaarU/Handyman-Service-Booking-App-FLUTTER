...
class PolSignPage extends StatefulWidget {
  const PolSignPage({super.key});

  @override
  State<PolSignPage> createState() => _PolSignPageState();
}

class _PolSignPageState extends State<PolSignPage> {
  // Initial quantity
  int _quantity = 1;

  // Pricing details for Pol Sign service
  final double _itemPrice = 399; // Price per item
