...
class WallpaperRemovalPage extends StatefulWidget {
  const WallpaperRemovalPage({super.key});

  @override
  State<WallpaperRemovalPage> createState() => _WallpaperRemovalPageState();
}

class _WallpaperRemovalPageState extends State<WallpaperRemovalPage> {
