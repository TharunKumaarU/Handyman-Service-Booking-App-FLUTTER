...
class CctvRepairPage extends StatefulWidget {
  const CctvRepairPage({super.key});

  @override
  State<CctvRepairPage> createState() => _CctvRepairPageState();
}

class _CctvRepairPageState extends State<CctvRepairPage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for repair
  final double _itemPrice = 150; // Price per repair service
  final double _convenienceFee = 5; // Flat convenience fee
