...
class StrWoodRoofPage extends StatefulWidget {
  const StrWoodRoofPage({super.key});

  @override
  State<StrWoodRoofPage> createState() => _StrWoodRoofPageState();
}

class _StrWoodRoofPageState extends State<StrWoodRoofPage> {
  int _quantity = 1;
  final double _itemPrice = 699; // Price per item for Wood Roof Structure
