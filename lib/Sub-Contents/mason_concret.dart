...
class MasonConcretPage extends StatefulWidget {
  const MasonConcretPage({super.key});

  @override
  State<MasonConcretPage> createState() => _MasonConcretPageState();
}

class _MasonConcretPageState extends State<MasonConcretPage> {
  int _quantity = 1;
  final double _itemPrice = 599;
  final double _convenienceFee = 10;
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Description text (adjust as needed)
                      const Text(
