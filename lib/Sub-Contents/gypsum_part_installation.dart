...
class GypsumPartInstallationPage extends StatefulWidget {
  const GypsumPartInstallationPage({super.key});

  @override
  State<GypsumPartInstallationPage> createState() =>
      _GypsumPartInstallationPageState();
}

class _GypsumPartInstallationPageState
    extends State<GypsumPartInstallationPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 299;
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Gypsum Part Installation',
      'quantity': _quantity,
