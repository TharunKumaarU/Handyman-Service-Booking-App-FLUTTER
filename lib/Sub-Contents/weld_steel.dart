...
class WeldSteelPage extends StatefulWidget {
  const WeldSteelPage({super.key});

  @override
  State<WeldSteelPage> createState() => _WeldSteelPageState();
}

class _WeldSteelPageState extends State<WeldSteelPage> {
  int _quantity = 1;
  final double _itemPrice = 500; // Price per item for Weld Steel
