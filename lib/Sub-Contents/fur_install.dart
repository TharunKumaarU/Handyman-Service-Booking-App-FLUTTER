...
class FurInstallPage extends StatefulWidget {
  const FurInstallPage({super.key});
  @override
  State<FurInstallPage> createState() => _FurInstallPageState();
}

class _FurInstallPageState extends State<FurInstallPage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for Furniture Installation
  final double _itemPrice = 449; // Price per item
