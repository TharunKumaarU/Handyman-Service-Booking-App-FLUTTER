...
class GypsumPartCustomPage extends StatefulWidget {
  const GypsumPartCustomPage({super.key});

  @override
  State<GypsumPartCustomPage> createState() => _GypsumPartCustomPageState();
}

class _GypsumPartCustomPageState extends State<GypsumPartCustomPage> {
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Gypsum Part Customization',
      'quantity': _quantity,
