...
class AcWinPage extends StatefulWidget {
  const AcWinPage({super.key});

  @override
  State<AcWinPage> createState() => _AcWinPageState();
}

class _AcWinPageState extends State<AcWinPage> {
  // Initial quantity
  int _quantity = 1;

  // Pricing details
  final double _itemPrice = 129; // Price per item for AC Window Service
