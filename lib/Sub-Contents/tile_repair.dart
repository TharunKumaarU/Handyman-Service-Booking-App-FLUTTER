...
class TileRepairPage extends StatefulWidget {
  const TileRepairPage({super.key});

  @override
  State<TileRepairPage> createState() => _TileRepairPageState();
}

class _TileRepairPageState extends State<TileRepairPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 199; // Price per tile repair
  final double _convenienceFee = 6; // Flat convenience fee
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Row with service name and hourly price
                      Row(
                ...
                const SizedBox(height: 20),
                // NOTE Container (replacing the cancellation policy)
                Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
