...
class CeilingGypInstPage extends StatefulWidget {
  const CeilingGypInstPage({super.key});

  @override
  State<CeilingGypInstPage> createState() => _CeilingGypInstPageState();
}

class _CeilingGypInstPageState extends State<CeilingGypInstPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 250;
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Ceiling Gypsum Installation',
      'quantity': _quantity,
