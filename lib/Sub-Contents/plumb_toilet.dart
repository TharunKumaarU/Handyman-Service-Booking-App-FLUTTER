...
class PlumbToiletPage extends StatefulWidget {
  const PlumbToiletPage({super.key});

  @override
  State<PlumbToiletPage> createState() => _PlumbToiletPageState();
}

class _PlumbToiletPageState extends State<PlumbToiletPage> {
  int _quantity = 1;
  final double _itemPrice = 109; // Price per service
