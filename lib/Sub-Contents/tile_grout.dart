...
class TileGroutPage extends StatefulWidget {
  const TileGroutPage({super.key});

  @override
  State<TileGroutPage> createState() => _TileGroutPageState();
}

class _TileGroutPageState extends State<TileGroutPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 149; // Price per tile grout cleaning
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 20),
                // NOTE Container (replacing the original cancellation policy)
                Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
