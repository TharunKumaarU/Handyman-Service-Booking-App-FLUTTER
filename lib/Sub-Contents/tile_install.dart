...
class TileInstallPage extends StatefulWidget {
  const TileInstallPage({super.key});

  @override
  State<TileInstallPage> createState() => _TileInstallPageState();
}

class _TileInstallPageState extends State<TileInstallPage> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Service name and hourly price row
                      Row(
