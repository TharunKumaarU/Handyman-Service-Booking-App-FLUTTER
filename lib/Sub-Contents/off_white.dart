...
class OffWhitePage extends StatefulWidget {
  const OffWhitePage({super.key});

  @override
  State<OffWhitePage> createState() => _OffWhitePageState();
}

class _OffWhitePageState extends State<OffWhitePage> {
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Off White / White Painting',
      'quantity': _quantity,
