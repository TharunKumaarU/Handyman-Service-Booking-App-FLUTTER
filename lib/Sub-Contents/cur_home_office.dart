...
class CurtainHomeOfficePage extends StatefulWidget {
  const CurtainHomeOfficePage({super.key});

  @override
  State<CurtainHomeOfficePage> createState() => _CurtainHomeOfficePageState();
}

class _CurtainHomeOfficePageState extends State<CurtainHomeOfficePage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for Curtain Home Office
  final double _itemPrice = 549; // Price per item
