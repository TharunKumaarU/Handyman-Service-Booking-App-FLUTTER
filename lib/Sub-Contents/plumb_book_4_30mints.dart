...
class PlumbBook430MintsPage extends StatefulWidget {
  const PlumbBook430MintsPage({super.key});

  @override
  State<PlumbBook430MintsPage> createState() => _PlumbBook430MintsPageState();
}

class _PlumbBook430MintsPageState extends State<PlumbBook430MintsPage> {
  int _quantity = 1;
  final double _itemPrice = 99; // Price per item
