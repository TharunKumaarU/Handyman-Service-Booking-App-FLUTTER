...
class GypsumPartRepairPage extends StatefulWidget {
  const GypsumPartRepairPage({super.key});

  @override
  State<GypsumPartRepairPage> createState() => _GypsumPartRepairPageState();
}

class _GypsumPartRepairPageState extends State<GypsumPartRepairPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 149;
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Gypsum Partition Repair',
      'quantity': _quantity,
