...
class CarWoodWorkPage extends StatefulWidget {
  const CarWoodWorkPage({super.key});

  @override
  State<CarWoodWorkPage> createState() => _CarWoodWorkPageState();
}

class _CarWoodWorkPageState extends State<CarWoodWorkPage> {
  int _quantity = 1;
  final double _itemPrice = 450; // Price per item
