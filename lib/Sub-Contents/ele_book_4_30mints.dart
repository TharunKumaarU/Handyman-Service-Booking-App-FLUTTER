...
class EleBook4MintsPage extends StatefulWidget {
  const EleBook4MintsPage({super.key});

  @override
  State<EleBook4MintsPage> createState() => _EleBook4MintsPageState();
}

class _EleBook4MintsPageState extends State<EleBook4MintsPage> {
  int _quantity = 1;
