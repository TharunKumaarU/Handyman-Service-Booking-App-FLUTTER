...
class EleSwitchPage extends StatefulWidget {
  const EleSwitchPage({super.key});

  @override
  State<EleSwitchPage> createState() => _EleSwitchPageState();
}

class _EleSwitchPageState extends State<EleSwitchPage> {
  int _quantity = 1;
  final double _itemPrice = 79;
