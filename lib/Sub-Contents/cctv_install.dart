...
class CctvInstallPage extends StatefulWidget {
  const CctvInstallPage({super.key});

  @override
  State<CctvInstallPage> createState() => _CctvInstallPageState();
}

class _CctvInstallPageState extends State<CctvInstallPage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for installation
  final double _itemPrice = 500; // Price per installation service
