...
class WeldGrillPage extends StatefulWidget {
  const WeldGrillPage({super.key});

  @override
  State<WeldGrillPage> createState() => _WeldGrillPageState();
}

class _WeldGrillPageState extends State<WeldGrillPage> {
  int _quantity = 1;
  final double _itemPrice = 450; // Price per item for Weld Grill
