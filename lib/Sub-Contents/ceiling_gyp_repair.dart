...
class CeilingGypRepairPage extends StatefulWidget {
  const CeilingGypRepairPage({super.key});

  @override
  State<CeilingGypRepairPage> createState() => _CeilingGypRepairPageState();
}

class _CeilingGypRepairPageState extends State<CeilingGypRepairPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 199;
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Ceiling Gypsum Repair',
      'quantity': _quantity,
