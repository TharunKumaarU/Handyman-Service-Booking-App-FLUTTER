...
class WallpaperInstallationPage extends StatefulWidget {
  const WallpaperInstallationPage({super.key});

  @override
  State<WallpaperInstallationPage> createState() =>
      _WallpaperInstallationPageState();
}

class _WallpaperInstallationPageState extends State<WallpaperInstallationPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 399;
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                // Service/Quantity Container (mirroring off_white.dart)
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Row: Service name and price label
                      Row(
                ...
                const SizedBox(height: 20),
                // NOTE Container (same as off_white.dart)
                Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
