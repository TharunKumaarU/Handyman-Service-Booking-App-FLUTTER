...
class WallpaperRepairPage extends StatefulWidget {
  const WallpaperRepairPage({super.key});

  @override
  State<WallpaperRepairPage> createState() => _WallpaperRepairPageState();
}

class _WallpaperRepairPageState extends State<WallpaperRepairPage> {
