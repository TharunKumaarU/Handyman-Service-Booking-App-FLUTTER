...
class PlumbBlkDrainPage extends StatefulWidget {
  const PlumbBlkDrainPage({super.key});

  @override
  State<PlumbBlkDrainPage> createState() => _PlumbBlkDrainPageState();
}

class _PlumbBlkDrainPageState extends State<PlumbBlkDrainPage> {
  int _quantity = 1;
  final double _itemPrice = 149; // Price per service
