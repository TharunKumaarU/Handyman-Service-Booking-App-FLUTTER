...
class CarFurRepairPage extends StatefulWidget {
  const CarFurRepairPage({super.key});

  @override
  State<CarFurRepairPage> createState() => _CarFurRepairPageState();
}

class _CarFurRepairPageState extends State<CarFurRepairPage> {
  int _quantity = 1;
  final double _itemPrice = 350; // Price per item
