...
class CleanHousePage extends StatefulWidget {
  const CleanHousePage({super.key});

  @override
  State<CleanHousePage> createState() => _CleanHousePageState();
}

class _CleanHousePageState extends State<CleanHousePage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for House Cleaning
  final double _itemPrice = 200; // Price per service
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: const Text('Add Address and Slot'),
          ),
        ),
      ),
    );
