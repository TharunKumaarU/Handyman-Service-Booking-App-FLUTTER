...
class EleBookHrlyPage extends StatefulWidget {
  const EleBookHrlyPage({super.key});

  @override
  State<EleBookHrlyPage> createState() => _EleBookHrlyPageState();
}

class _EleBookHrlyPageState extends State<EleBookHrlyPage> {
  int _quantity = 1;
