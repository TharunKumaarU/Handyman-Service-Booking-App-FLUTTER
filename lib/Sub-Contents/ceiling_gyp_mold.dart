...
class CeilingGypMoldPage extends StatefulWidget {
  const CeilingGypMoldPage({super.key});

  @override
  State<CeilingGypMoldPage> createState() => _CeilingGypMoldPageState();
}

class _CeilingGypMoldPageState extends State<CeilingGypMoldPage> {
  String? mobileKey; // from route arguments
  int _quantity = 1;
  final double _itemPrice = 389;
  ...
  Future<void> _saveData() async {
    ...
    await FirebaseFirestore.instance.collection('address').doc(mobileKey).set({
      'serviceName': 'Ceiling Gypsum Mold Treatment',
      'quantity': _quantity,
