...
class PlumbTapPage extends StatefulWidget {
  const PlumbTapPage({super.key});

  @override
  State<PlumbTapPage> createState() => _PlumbTapPageState();
}

class _PlumbTapPageState extends State<PlumbTapPage> {
  int _quantity = 1;
  final double _itemPrice = 89; // Price per service
