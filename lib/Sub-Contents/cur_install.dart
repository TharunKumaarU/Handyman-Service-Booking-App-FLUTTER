...
class CurtainInstallPage extends StatefulWidget {
  const CurtainInstallPage({super.key});

  @override
  State<CurtainInstallPage> createState() => _CurtainInstallPageState();
}

class _CurtainInstallPageState extends State<CurtainInstallPage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for Curtain Installation
