...
class CleanCommercialPage extends StatefulWidget {
  const CleanCommercialPage({super.key});

  @override
  State<CleanCommercialPage> createState() => _CleanCommercialPageState();
}

class _CleanCommercialPageState extends State<CleanCommercialPage> {
  // Initial quantity
  int _quantity = 1;

  // Example pricing for Commercial Cleaning
  final double _itemPrice = 500; // Price per service
  final double _convenienceFee = 15; // Flat convenience fee
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  // Service name & quantity controls
                  Column(
