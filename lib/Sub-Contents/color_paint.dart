...
class ColorPaintingPage extends StatefulWidget {
  const ColorPaintingPage({super.key});

  @override
  State<ColorPaintingPage> createState() => _ColorPaintingPageState();
}

class _ColorPaintingPageState extends State<ColorPaintingPage> {
  String? mobileKey; // from route arguments

  int _quantity = 1;
  final double _itemPrice = 439;
