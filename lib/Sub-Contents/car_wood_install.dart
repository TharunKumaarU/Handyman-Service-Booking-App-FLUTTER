...
class CarWoodInstallPage extends StatefulWidget {
  const CarWoodInstallPage({super.key});

  @override
  State<CarWoodInstallPage> createState() => _CarWoodInstallPageState();
}

class _CarWoodInstallPageState extends State<CarWoodInstallPage> {
  int _quantity = 1;
  final double _itemPrice = 500; // Price per item
